              ...
              <div className="row">
                    ...
                    <form action="" className="row g-4" onSubmit={handleLogin}>
                      ...
                      <div className="col-12 d-flex justify-content-between">
                        <button
                          ...
                          style={{
                            backgroundColor: "#fff",
                            border: "1px solid #7a44e0",
                          }}
                        >
                          <Link
                            to="/signup"
                            style={{ textDecoration: "none", color: "#7a44e0" }}
                          >
                            회원가입
                          </Link>
                        </button>
                        <button
                          type="submit"
                          className="btn px-4 float-end mt-4"
                          style={{ color: "white", backgroundColor: "#7a44e0" }}
                        >
                          로그인
                        </button>
                      </div>
                ...
                <div className="col-md-5 ps-0 d-none d-md-block">
                  <div
                    ...
                    style={{
                      backgroundColor: "#7a44e0",
                      borderBottomRightRadius: "25px",
                      borderTopRightRadius: "25px",
                    }}
                  >
                    <i className="bi bi-bootstrap"></i>
                    <h2 className="fs-1" style={{ marginTop: "45px" }}>
                      나만의 캠퍼스
                    </h2>
