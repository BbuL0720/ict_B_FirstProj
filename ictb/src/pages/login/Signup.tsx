      ...
      <div className={style.container}>     
        ...
        <form className={style.form}>     
            ...
            <div className="mb-4">
                ...
                <button type='button' className='btn w-30' style={{float:'right',marginTop:'5px', color:'white', background:'#7a44e0'}}>중복확인</button>
            </div>
             <div className="mb-4">
                <label>비밀번호</label>
            ...
            <div className="mb-5">
                ...
                <button type='submit'className='btn w-30' style={{float:'right', marginTop:'5px', color:'white', background:'#7a44e0'}}>인증하기</button>                   
            </div>
              <div className="mb-5">
                <label>인증번호</label>              
                <input type="text" className="form-control" placeholder="인증번호를 입력해주세요"/>
                <button type='submit'className='btn w-30' style={{float:'right', marginTop:'5px', color:'white', background:'#7a44e0'}}>확인</button>                   
            </div>
            <button type="submit" className="btn w-100" style={{color:'white', background:'#7a44e0'}}>가입하기</button>
        </form>
